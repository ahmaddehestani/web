...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'attribute-product-interface-few'   => 'پارامترهای :items ارسال نشده اند، شما باید آیتم های :need را ارسال کنید.',
        'attribute-product-interface-many'  => 'پارامترهای :items اضافی ارسال شده اند، شما باید آیتم های :need را ارسال کنید.',
        'attribute-value-product-interface' => 'مقادیر پارامتر :item اشتباه ارسال شده اند، شما باید از مقادیر :need در این پارامتر استفاده کنید.',
        'exist-product'                     => 'چنین کالایی از قبل وجود دارد.',
        'exist-gallery-variation'           => 'چنین گالری ای از قبل وجود دارد.',
        'required_star_in_comment_rule'     => 'مقدار امتیاز برای کامنت ارسال نشده است.',


        'gateway-info-incomplete' => 'اطلاعات درگاه ناقص است.',
    ],
    ...
    */
    ...
    'attributes' => [
        ...
        'translation.fa.title'   => 'نام',
        'translation.fa.summery' => 'خلاصه',
        'translation.fa.body'    => 'توضیحات',
        'attribute_id'           => 'ویژگی',
        'slug'                   => 'نامک',
        'image_uuid'             => 'تصویر',
        'count'                  => 'تعداد',
        ...
        'known_type_uuid'                 => 'ایدی نحوه اشنایی',
        'customer_type_uuid'              => 'ایدی نحوه فروش',
        'note'                            => 'یادداشت',
        'accounts.*.first_balance_sign'   => 'ماهیت',
        'accounts.*.first_balance_amount' => 'مانده اول دوره',
        'accounts.*.uuid'                 => 'حساب',
